...
local China_Chatspam = {"HAMEWARE最佳", "HAMEWARE上衣", "脚本黑客软件", "亚马逊", "淘金者", "打包机黑客hameware", "天安门广场是假的，上面有hameware, tianamen square", "乔治·弗洛伊德", "男人女人猫中国顶", "可怕的黑人", "是粘贴软件", "x值得", "水冰盐", "阴茎手术", "黑色生活无所谓BLM", "femboyes是同性恋"}
local uion = true
